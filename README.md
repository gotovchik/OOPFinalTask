...
**23.01.2023 10:12** Исправление ошибок.  

## Итоги

Задание выполнено, консольное приложению работает, но находиться в очень сыром виде, есть ряд замечаний, например по обработке ввода пользователя. Код подлежит многочисленным исправлениям и рефакторингу, на которые на данный момент катастрофически нет времени.  
